...
((global, factory) => {
    ...
    jQuery.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), (i, name) => {
    ...
    jQuery.event = {
        ...
        fix: (originalEvent) => (originalEvent[jQuery.expando] ? originalEvent : new jQuery.Event(originalEvent)),
    ...
    jQuery.expr.pseudos.visible = (elem) => !!(elem.offsetWidth || elem.offsetHeight || elem.getClientRects().length);

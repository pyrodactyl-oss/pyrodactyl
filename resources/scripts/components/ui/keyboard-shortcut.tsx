...
const CommandIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill='none' height='12' viewBox='0 0 24 24' width='12' xmlns='http://www.w3.org/2000/svg' {...props}>
        <path d='M15 9V15H9V9H15Z' stroke='currentColor' strokeLinejoin='round' strokeWidth='1.5' />
        <path
...
export const KeyboardShortcut: React.FC<KeyboardShortcutProps> = ({ keys, className, variant = 'default' }) => {
    ...
    return (
        <div className={cn('inline-flex select-none items-center gap-1 font-semibold text-sm', className)}>
            {keys.map((key, index) => (

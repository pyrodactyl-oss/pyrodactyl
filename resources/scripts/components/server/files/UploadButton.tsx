...
const UploadButton = () => {
    ...
    return (
        <>
            <FadeTransition appear duration='duration-75' key='upload_modal_mask' show={visible} unmount>
                <ModalMask
                    className='flex'
                ...
                >
                    <div className={'pointer-events-none flex w-full items-center justify-center'}>
                        <div
                            className={
                                'relative mx-10 flex w-full max-w-sm flex-col items-center gap-4 rounded-2xl bg-brand px-4 py-12'
                            }
                        >
                            <div className='absolute inset-4 rounded-xl border-2 border-[#ffffff88] border-dashed' />
                            <svg
                                className='h-8 w-8'
                                fill='none'
                                height='24'
                            ...
                            <h1
                                className={
                                    'relative w-full flex-1 truncate px-4 text-center font-bold text-lg tracking-tight'
                                }
                            >
                                Upload to {name}
                            </h1>

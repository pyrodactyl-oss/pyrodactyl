const ScheduleCheatsheetCards = () => (
    <>
        <div className={'h-full bg-zinc-600 md:w-1/2'}>
            <div className={'flex flex-col'}>
                <h2 className={'px-6 py-4 font-bold'}>Examples</h2>
                <div className={'flex bg-zinc-500 px-6 py-4'}>
        ...
        <div className={'h-full bg-zinc-600 md:w-1/2'}>
            <h2 className={'px-6 py-4 font-bold'}>Special Characters</h2>
            <div className={'flex flex-col'}>
                <div className={'flex bg-zinc-500 px-6 py-4'}>

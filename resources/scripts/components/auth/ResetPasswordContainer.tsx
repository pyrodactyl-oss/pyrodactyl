        ...
        <ContentBox>
            <Formik
                ...
                validationSchema={object().shape({
                    password: string()
                        .required(i18n.t('auth:reset.password_required'))
                        .min(8, i18n.t('auth:reset.password_min')),
                    password_confirmation: string()
                        .required(i18n.t('auth:reset.password_mismatch'))
                        .oneOf([ref('password')], i18n.t('auth:reset.password_mismatch')),
                })}
            >
                {({ isSubmitting }) => (
                    <LoginFormContainer className={`w-full flex`}>
                        ...
                        <h2 className='text-xl font-extrabold mb-2'>{t('reset.title')}</h2>

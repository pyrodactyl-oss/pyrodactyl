...
/*
|--------------------------------------------------------------------------
| General Strings Language Lines
|--------------------------------------------------------------------------
|
...
return [
    ...
    'node_deploy_key_memo' => 'Automatically generated node deployment key.',
    'log_not_found' => 'Log not found',
    'backup_invalid_response' => 'Invalid response: missing data',
    'backup_process_failed' => 'Failed to process backup response',
    'backup_unknown_structure' => 'Invalid response: unknown structure',
    'operation_polling_timeout' => 'Operation polling timed out after 15 minutes',
    'operation_not_active' => 'Operation is no longer active',
    'validation_failed_prefix' => 'Validation failed:',
    'modrinth_failed_loaders' => 'Failed to fetch loaders',
    'modrinth_failed_versions' => 'Failed to fetch game versions',
    'modrinth_failed_search' => 'Failed to search mods',

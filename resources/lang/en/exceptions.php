...
return [
    ...
    'allocations' => [
        'no_space' => 'Cannot assign additional allocation: no more space available on node.',
        'cannot_resolve' => "Cannot resolve allocation IP/hostname ':ip' to a valid IP address",
    ],
    'backup' => [
